    ...
    constructor() {
      ...
      this.state = {date: date, startDate: '',
                    ...
                    years: ["2021","2022","2023","2024","2025","2026","2027","2028","2029", "2030"],
                     title: '06', year: '2021', cvv: '', cardNumber: '6011 2312 3890 4238', cardName: 'John Doves', card: '', expiry: '', setter: false
                   };
...
handleSelectMonth(e){
  ...
  updateInputValueCardNumber(e){
    ...
    // let res = x.replace(/(\d{4})/g, '$1 ').replace(/(^\s+|\s+$)/,'')
    // console.log(res);



    // const value = e.target.value
    // const newFormat = value.toString().replace(/\d{4}(?=.)/g, '$& ');
    this.setState({cardNumber: e.target.value})
    this.setState({setter: false});
...
addUser = event =>{
  alert('An essay was submitted: ' + this.state.cardName);
  alert('An essay was submitted: ' + this.state.cardNumber);
  alert('An essay was submitted: ' + this.state.year);
  alert('An essay was submitted: ' + this.state.title);
  alert('An essay was submitted: ' + this.state.cvv);
